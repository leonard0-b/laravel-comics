...
Route::get('/', function () {
    return view('home')->with('comics', config('comics')); //primo parametro assegno il nome alla variabile, secondo parametro cerco nella cartella config il file "comics" (il database)
})->name('home');
